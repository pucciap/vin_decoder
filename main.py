...
engine_dict = {
    "V": "1.5L I4 DI DOHC T/C",
    "X": "2.0L I4 DI DOHC T/C",
    "6": "6.2L V8 DI OHV S/C""",
    "7": "6.2L V8 DI OHV",
    "S": "3.6L V6 DI DOHC",
    "0": "65kw",
    "3": "3.6L V6 SIDI DOHC VVT Flex",
}
...
trim_level_dict = {
    "X5": "Equinox 1LS 1.5L AWD",
    "XF": "Equinox 1LS 1.5L FWD",
    "XG": "Equinox L FWD",
    "XH": "Equinox L FWD",
    "XJ": "Equinox 1LT 1.5L FWD",
    "XK": "Equinox 1LT 1.5L FWD",
    "XL": "Equinox 2LT 2.0L FWD",
    "XN": "Equinox 2LT 2.0L FWD",
    "XP": "Equinox 2LT 2.0L FWD",
    "XS": "Equinox LS AWD",
    "XT": "Equinox 1LT 1.5L AWD",
    "XU": "Equinox 1LT 1.5L AWD",
    "XV": "Equinox 2LT 2.0L AWD",
    "XX": "Equinox 1LT 1.5L AWD",
    "XY": "Equinox 1.5 Premier FWD",
    "F9": "Non-US, Non-Canada",
    "FA": "Camaro 1LS or 1LT 6sp",
    "FB": "Camaro 1LT Auto",
    "FC": "Camaro 2LT 6sp",
    "FD": "Camaro 2LT Auto",
    "FE": "Camaro 1SS 6sp",
    ...
    "FJ": "Camaro ZL1 6sp",
    "FK": "Camaro ZL1 Auto",
    "F7": "Bolt Non-US, Non-Canada",
    "FW": "Bolt LT",
    "FX": "Bolt Premier",
    "FY": "Bolt LT w/Fast Charge",
    "FZ": "Bolt Premier w/Fast Charge",
    "10": "Impala Premier",
...
# function for chevy camaro trims


def get_camaro_trim_level_from_vin(vin_number):
...
# function for chevy equinox trims

def get_equinox_trim_level_from_vin(vin_number):
    for trim_level_key, trim_level_value in trim_level_dict.items():
...
trim = get_equinox_trim_level_from_vin(vin_number) or get_camaro_trim_level_from_vin(vin_number)
